...
3. Proper payment according to Registration fees calculated from your status and attendance. The table for Early Bird Registration fees is recalled underneath. Payment will be possible: by credit card; by bank transfer (even for non-French institution: choose anyway the red box reading "Réservé aux établissements français" and select the last bullet: "Virement ou bon de commande" ([picture](pics/register.jpg)); then you will receive the invoice by email and will be able to pay by bank transfer); by "chèque" (from french banks) or “bon de commande administratif” (mostly for french institutions).
...
**Early Bird is for Registration up to** ~~July 16~~ ~~July 27, 2021~~ **September 3, 2021**
